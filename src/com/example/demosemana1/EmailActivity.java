...
public class EmailActivity extends ListActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SimpleAdapter adapter = new SimpleAdapter(this, emails, android.R.layout.simple_list_item_activated_2, new String[] {EMAIL, DATE_ADDED}, new int[]{android.R.id.text1, android.R.id.text2});
	...
	public void onClick(View v) {
		...
		String date = new SimpleDateFormat("dd/MM/yy HH:mm", Locale.getDefault()).format(Calendar.getInstance().getTime());
